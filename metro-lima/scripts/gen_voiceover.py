#!/usr/bin/env python3
"""Generate per-paragraph Spanish narration with Edge TTS, measure durations, concat."""
import json
import os
import subprocess
import sys
...
final = os.path.join(VO, "narration.es.mp3")
subprocess.run(
...
print(f"final narration.es.mp3: {float(out.stdout.strip()):.3f}s")
